// mLink_12CH_Servo_Step_Example_Print.ino
// Add some printing
...
void setup() 
{
  ...
  Serial.begin(115200);
  Serial.println("Servo Step Example");

  mLink.servo0_On(I2C_ADD);                           // Enable output for the first servo
  Serial.println(mLink.servo0_getLimLow(I2C_ADD));
  Serial.println(mLink.servo0_getLimHigh(I2C_ADD));
}
...
void loop() 
{
  ...
  Serial.println(mLink.servo0_GetPos(I2C_ADD));
